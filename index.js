  ...
  res.send(`
    ...
    <body>
      <div class="container mt-5">
        ...
        <p>User: ${req.oidc.user.email}</p>
        <p>Auth Status: ${req.oidc.isAuthenticated() ? 'Logged In' : 'Not Logged In'}</p>
        <a href="/apps" class="btn btn-primary">Go to Apps</a>
        <a href="/account" class="btn btn-secondary">Go to Account</a>
        <hr>
        <h3>Test API Call:</h3>
        <button onclick="testAPI()" class="btn btn-success">Test Applications API</button>
